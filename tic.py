...
def play_tic_tac_toe_with_camera(detect, cap):
        ...
        while True:
            ...
            if player_turn:
                cv2.putText(frame, "Play PC", (10, 30), cv2.FONT_HERSHEY_PLAIN , 1, (0,0,0), 2, cv2.LINE_AA)
            else:
                cv2.putText(frame, "Cobot play", (10, 30), cv2.FONT_HERSHEY_PLAIN , 1, (0,0,0), 2, cv2.LINE_AA)
